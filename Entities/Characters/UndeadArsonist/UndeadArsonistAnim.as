...
{
	string texname = "../UndeadArsonist.png";
	...
	CSpriteLayer@ shiny = this.addSpriteLayer(shiny_layer, "BlackFireBallReady.png", 16, 16);
...
void onTick(CSprite@ this)
{
	...
	const bool flaming = blob.isKeyPressed(key_action2);
