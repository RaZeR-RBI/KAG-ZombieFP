...
void InitLoot( CBlob@ this )
{
    ...
    */
	...
	addLoot(this, "mat_fireorbs", 1, 10);
	addLoot(this, "gasbag", 2, 1);
	//addLoot(this, "sburd", 2, 1);
	addLoot(this, "sbunny", 2, 1);
	addLoot(this, "sfshark", 3, 1);
	// addLoot(this, "szombie", 4, 1);
    addLoot(this, "zbison", 5, 1); //chest will drop coins with quantity 1 - 60
