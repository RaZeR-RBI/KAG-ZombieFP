...
void GetButtonsFor( CBlob@ this, CBlob@ caller )
{
	...
	if (kek == 1)
	{	
		caller.CreateGenericButton( 11, Vec2f_zero, this, this.getCommandID("sstalker"), "Use this to change into a stalker.", params );
	}
}

void onCommand( CBlob@ this, u8 cmd, CBitStream @params )
{
	if (cmd == this.getCommandID("sstalker"))
	{
        ...
        if (getNet().isServer() )
        {
            if (caller !is null)
            {
                ...
                string classconfig = "undeadstalker";//params.read_string();
