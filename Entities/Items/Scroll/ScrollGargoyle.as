...
void GetButtonsFor( CBlob@ this, CBlob@ caller )
{
	...
	if (kek == 1)
	{	
		caller.CreateGenericButton( 11, Vec2f_zero, this, this.getCommandID("sgargoyle"), "Use this to change into a gargoyle.", params );
	}
}

void onCommand( CBlob@ this, u8 cmd, CBitStream @params )
{
	if (cmd == this.getCommandID("sgargoyle"))
	{
        ...
        if (getNet().isServer() )
        {
            if (caller !is null)
            {
                ...
                string classconfig = "undeadgargoyle";//params.read_string();
