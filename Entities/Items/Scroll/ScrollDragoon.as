...
void GetButtonsFor( CBlob@ this, CBlob@ caller )
{
	...
	if (kek == 0)
	{	
		caller.CreateGenericButton( 11, Vec2f_zero, this, this.getCommandID("sdragoon"), "Use this to change into a dragoon.", params );
	}
}

void onCommand( CBlob@ this, u8 cmd, CBitStream @params )
{
	if (cmd == this.getCommandID("sdragoon"))
	{
        ...
        if (getNet().isServer() )
        {
            if (caller !is null)
            {
                ...
                string classconfig = "dragoon";//params.read_string();
