...
void GetButtonsFor( CBlob@ this, CBlob@ caller )
{
	...
	if (kek == 0)
	{
		caller.CreateGenericButton( 11, Vec2f_zero, this, this.getCommandID("sbuilder"), "Use this to change into a chicken builder.", params );
	}	
}

void onCommand( CBlob@ this, u8 cmd, CBitStream @params )
{
	if (cmd == this.getCommandID("sbuilder"))
	{
        ...
        if (getNet().isServer() )
        {
            if (caller !is null)
            {
                ...
                string classconfig = "burd";//params.read_string();
