...
void GetButtonsFor( CBlob@ this, CBlob@ caller )
{
	...
	if (kek == 0)
	{	
		caller.CreateGenericButton( 11, Vec2f_zero, this, this.getCommandID("swizard"), "Use this to change into a wizard.", params );
	}
}

void onCommand( CBlob@ this, u8 cmd, CBitStream @params )
{
	if (cmd == this.getCommandID("swizard"))
	{
        ...
        if (getNet().isServer() )
        {
            if (caller !is null)
            {
                ...
                string classconfig = "wizard";//params.read_string();
