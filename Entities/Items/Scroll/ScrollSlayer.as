...
void GetButtonsFor( CBlob@ this, CBlob@ caller )
{
	...
	if (kek == 1)
	{	
		caller.CreateGenericButton( 11, Vec2f_zero, this, this.getCommandID("sslayer"), "Use this to change into a slayer.", params );
	}
}

void onCommand( CBlob@ this, u8 cmd, CBitStream @params )
{
	if (cmd == this.getCommandID("sslayer"))
	{
        ...
        if (getNet().isServer() )
        {
            if (caller !is null)
            {
                ...
                string classconfig = "undeadslayer";//params.read_string();
