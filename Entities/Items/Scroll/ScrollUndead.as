...
{
	this.addCommandID( "irejectmyhumanityjojo" );
}
...
void GetButtonsFor( CBlob@ this, CBlob@ caller )
{
	...
	u8 num_undead = undead_blobs.length;
	
	if (kek == 0 && num_undead < 3)
	{
		caller.CreateGenericButton( 11, Vec2f_zero, this, this.getCommandID("irejectmyhumanityjojo"), "Reject your humanity and become an undead. You can't do use this if there are more than 3 undead already.", params );
	}
}

void onCommand( CBlob@ this, u8 cmd, CBitStream @params )
{
	if (cmd == this.getCommandID("irejectmyhumanityjojo"))
	{
